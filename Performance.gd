...
func _process(_delta) -> void:
	...
	get_child(15).set_text("RENDER_VIDEO_MEM_USED: " + str(stepify(Performance.get_monitor(Performance.RENDER_VIDEO_MEM_USED) / 1000000.0,0.01)) + "MB")
	get_child(16).set_text("RENDER_TEXTURE_MEM_USED: " + str(stepify(Performance.get_monitor(Performance.RENDER_TEXTURE_MEM_USED) / 1000000.0,0.01)) + "MB")
	get_child(17).set_text("RENDER_VERTEX_MEM_USED: " + str(stepify(Performance.get_monitor(Performance.RENDER_VERTEX_MEM_USED) / 1000000.0,0.01)) + "MB")
