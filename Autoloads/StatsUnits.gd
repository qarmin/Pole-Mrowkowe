...
enum TYPES_OF_ANTS { NO_UNIT = 0, WORKER, SWORDMAN, ARCHER, HORSEMAN, ANT_MAX }
...
func _ready() -> void:
	...
	add_ant({"name": "archer", "type" : TYPES_OF_ANTS.ARCHER ,"production" :{"wood": 10, "water": 10, "gold": 5, "food": 10,}})
	add_ant({"name": "horseman", "type" : TYPES_OF_ANTS.HORSEMAN ,"production" :{"wood": 5, "water": 15, "gold": 2, "food": 20,}})
