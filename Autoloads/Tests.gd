...
func Vector2i_test() -> void:
	...
	var vec_5 : Vector2i = Vector2i.new(31,25)
	...
	array.append(Vector2i.new(25,31))
	...
	assert(Vector2i.is_in_array_reversed(array,vec_5))
	...
	assert(Vector2i.is_in_array_reversed(array,Vector2i.new(31,25)))
